...
fn outing_parser_recognizes_only_explicit_trimmed_forms() {
    let cases = [
        ...
        ("你去逛逛", UserInputIntent::Explore { direction: None }),
        ("去吧出去逛逛", UserInputIntent::Explore { direction: None }),
        ("逛逛", UserInputIntent::Explore { direction: None }),
        ("你决定去哪玩", UserInputIntent::Explore { direction: None }),
        ...
        ("我想自己逛逛", UserInputIntent::Chat),
        ("自己去玩吧", UserInputIntent::Chat),
        ("我们自己逛逛吧", UserInputIntent::Chat),
        ("我们去逛逛", UserInputIntent::Chat),
        ("你自己想去哪儿玩", UserInputIntent::Chat),
        ("你去过公园玩吗", UserInputIntent::Chat),
        ...
        ("去公园要不要玩", UserInputIntent::Chat),
        ("去公园该不该玩", UserInputIntent::Chat),
        ("去公园应不应该玩", UserInputIntent::Chat),
        ("去公园能否玩", UserInputIntent::Chat),
        ("去公园有没有必要玩", UserInputIntent::Chat),
        ("去公园不好玩", UserInputIntent::Chat),
